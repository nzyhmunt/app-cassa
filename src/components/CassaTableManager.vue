          ...
          <div class="p-4 md:p-6 flex-1 overflow-y-auto">
            ...
            <div v-if="tableTransactions.length > 0" class="mb-5 space-y-2">
              ...
              <div v-for="(txn, tIdx) in tableTransactions" :key="txn.transactionId"
                ...
                <span class="text-[9px] font-medium opacity-80">{{ new Date(txn.timestamp).toLocaleTimeString('it-IT', { hour: '2-digit', minute: '2-digit', timeZone: 'Europe/Rome' }) }} - ID: {{ txn.transactionId }}</span>
              </div>
            </div>
