...
export const appConfig = {
  ...
  menu: {
  	...
  	"Secondi Piatti": [
  		...
  		{ "id": "sec_4", "name": "BaccalÃ  in umido con crostone", "descrizione": "Stewed salt cod served with toasted bread", "price": 13, "note": "", "ingredienti": ["BaccalÃ ", "Pomodoro", "Pane"], "allergeni": ["glutine", "pesce"], "immagine_url": "" },
