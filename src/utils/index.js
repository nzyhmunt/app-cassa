...
export const appConfig = {
  ...
  menu: {
  	"Antipasti": [
  		...
  		{ "id": "ant_6", "name": "Panzanella e baccalà", "descrizione": "Soaked bread with fresh tomato juice and codfish on top", "price": 8, "note": "", "ingredienti": ["Pane", "Pomodoro", "Baccalà"], "allergeni": ["glutine", "pesce"], "immagine_url": "" },
